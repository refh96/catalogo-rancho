        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="space-y-4">
                ...
                <div className="mt-6 p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
                  <p className="text-sm text-indigo-800">
                    <strong>Nota:</strong> Para coordinar el reparto, contáctanos al finalizar tu compra.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 h-full">
            ...
            <div className="mt-4 text-center">
              <a 
                href="https://www.google.com/maps/search/?api=1&query=Av+La+Reconquista+4016+Hualpén+Chile"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <p className="text-gray-400">
              © 2024 Rancho de Mascotas Hualpén. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </footer>
